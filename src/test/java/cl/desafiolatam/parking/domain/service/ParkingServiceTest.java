...
class ParkingServiceTest {
        ...
        void shouldSaveAndReturnParkingStayWhenVehicleIsNotParked() {
                ...
                String licensePlateValue = "ABCD12";
                LicensePlate licensePlate = new LicensePlate(licensePlateValue);
                LocalDateTime entryTime = LocalDateTime.of(2026, 7, 22, 10, 0);
                ParkingStay savedStay = new ParkingStay(
                                licensePlate,
                                entryTime);
        ...
        void shouldStoreLicensePlateInNewParkingStay() {
                ...
                ParkingStay savedStay = new ParkingStay(
                                licensePlate,
                                entryTime);
                ArgumentCaptor<ParkingStay> parkingStayCaptor = ArgumentCaptor.forClass(ParkingStay.class);
        ...
        void shouldRejectEntryWhenVehicleIsAlreadyParked() {
                ...
                LicensePlate licensePlate = new LicensePlate(licensePlateValue);
                LocalDateTime entryTime = LocalDateTime.of(2026, 7, 22, 10, 0);
                ParkingStay activeStay = new ParkingStay(
                                licensePlate,
                                entryTime);
